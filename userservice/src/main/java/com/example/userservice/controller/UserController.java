...
public class UserController {
     ...
     */
    @PostMapping
    @Operation(summary = "1. Create user", description = "Creates a new user with the provided information")
    @ApiResponses(value = {
     ...
     */
    @GetMapping("/{id}")
    @Operation(summary = "2. Get user by ID", description = "Retrieves a user by their unique identifier")
    @ApiResponses(value = {
    ...
    public ResponseEntity<UserResponse> getUserById(@Parameter(description = "User ID") @PathVariable("id") Long id) {
     ...
     */
    @GetMapping
    @Operation(summary = "Extra: List all users", description = "Retrieves a list of all users")
    @ApiResponses(value = {
     ...
     */
    @PutMapping("/{id}")
    @Operation(summary = "3. Update user by ID", description = "Updates an existing user with new information")
    @ApiResponses(value = {
    ...
    public ResponseEntity<UserResponse> updateUser(@Parameter(description = "User ID") @PathVariable("id") Long id, 
     ...
     */
    @DeleteMapping("/{id}")
    @Operation(summary = "4. Delete user by ID", description = "Deletes a user by their unique identifier")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Extra: Check if user exists", description = "Checks if a user exists by their unique identifier")
    @ApiResponses(value = {
    ...
    public ResponseEntity<Void> checkUserExists(@Parameter(description = "User ID") @PathVariable("id") Long id) {
